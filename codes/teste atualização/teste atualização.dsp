# Microsoft Developer Studio Project File - Name="teste atualização" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) QuickWin Application" 0x0107

CFG=teste atualização - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "teste atualização.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "teste atualização.mak" CFG="teste atualização - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "teste atualização - Win32 Release" (based on "Win32 (x86) QuickWin Application")
!MESSAGE "teste atualização - Win32 Debug" (based on "Win32 (x86) QuickWin Application")
!MESSAGE 
...
!IF  "$(CFG)" == "teste atualização - Win32 Release"
...
!ELSEIF  "$(CFG)" == "teste atualização - Win32 Debug"
...
# Name "teste atualização - Win32 Release"
# Name "teste atualização - Win32 Debug"
