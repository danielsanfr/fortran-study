# Microsoft Developer Studio Project File - Name="exemplo não sei2" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) QuickWin Application" 0x0107

CFG=exemplo não sei2 - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "exemplo não sei2.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "exemplo não sei2.mak" CFG="exemplo não sei2 - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "exemplo não sei2 - Win32 Release" (based on "Win32 (x86) QuickWin Application")
!MESSAGE "exemplo não sei2 - Win32 Debug" (based on "Win32 (x86) QuickWin Application")
!MESSAGE 
...
!IF  "$(CFG)" == "exemplo não sei2 - Win32 Release"
...
!ELSEIF  "$(CFG)" == "exemplo não sei2 - Win32 Debug"
...
# Name "exemplo não sei2 - Win32 Release"
# Name "exemplo não sei2 - Win32 Debug"
