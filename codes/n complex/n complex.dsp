# Microsoft Developer Studio Project File - Name="n complex" - Package Owner=<4>
# Microsoft Developer Studio Generated Build File, Format Version 6.00
# ** DO NOT EDIT **

# TARGTYPE "Win32 (x86) QuickWin Application" 0x0107

CFG=n complex - Win32 Debug
!MESSAGE This is not a valid makefile. To build this project using NMAKE,
!MESSAGE use the Export Makefile command and run
!MESSAGE 
!MESSAGE NMAKE /f "n complex.mak".
!MESSAGE 
!MESSAGE You can specify a configuration when running NMAKE
!MESSAGE by defining the macro CFG on the command line. For example:
!MESSAGE 
!MESSAGE NMAKE /f "n complex.mak" CFG="n complex - Win32 Debug"
!MESSAGE 
!MESSAGE Possible choices for configuration are:
!MESSAGE 
!MESSAGE "n complex - Win32 Release" (based on "Win32 (x86) QuickWin Application")
!MESSAGE "n complex - Win32 Debug" (based on "Win32 (x86) QuickWin Application")
!MESSAGE 
...
!IF  "$(CFG)" == "n complex - Win32 Release"
...
!ELSEIF  "$(CFG)" == "n complex - Win32 Debug"
...
# Name "n complex - Win32 Release"
# Name "n complex - Win32 Debug"
